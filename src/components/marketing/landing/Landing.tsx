...
function Hero() {
  return (
    <section id="demo" className="relative overflow-hidden bg-[#0b0b0b] pt-16 text-white">
      ...
      <div className="container-page relative grid items-center gap-14 py-20 md:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <div>
          ...
          <h1
            className="font-heading mt-7 text-white"
            style={{ fontSize: "clamp(2.4rem, 5.4vw, 3.9rem)", lineHeight: 1.06 }}
          >
            Your record label,
            <br />
  ...
  return (
    <section className="border-y border-[color:var(--color-border)] bg-[color:var(--color-bg-surface)]">
      <div className="container-page grid grid-cols-2 gap-8 py-10 md:grid-cols-4">
        {HERO_STATS.map((s) => (
          <div key={s.label}>
            <p className="font-heading text-[30px] leading-none text-[color:var(--color-crimson)]">
              {s.value}
            </p>
      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {HOW_IT_WORKS.map((s) => (
            <div
              key={s.step}
              className="relative rounded-[10px] border border-[color:var(--color-border)] bg-white p-7 shadow-[var(--shadow-sm)]"
            >
              ...
              <h3 className="font-heading mt-5 text-[19px] text-[color:var(--color-black)]">
                {s.title}
              </h3>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {PRODUCT_SURFACES.map((p) => {
            ...
            return (
              <div
                key={p.id}
                className="group rounded-[10px] border border-[color:var(--color-border)] bg-white p-7 shadow-[var(--shadow-sm)] transition-shadow hover:shadow-[var(--shadow-md)]"
              >
                ...
                <p className="mt-4 text-[14.5px] leading-relaxed text-[color:var(--color-gray-mid)]">
                  {p.body}
                </p>
...
/**
 * Mirrors the real UserOps pipeline in `src/lib/userops/steps.ts` — the same
 * four steps a new account actually runs, in the same order.
 */
const DEPLOY_STEPS = [
  {
      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {TIERS.map((tier) => (
            ...
            >
              {tier.featured && (
                <span className="absolute -top-3 left-8 rounded-full bg-[color:var(--color-crimson)] px-3 py-1 text-[11px] font-bold text-white">
                  Most popular
                </span>
              )}
              <h3 className="font-heading text-[22px] text-[color:var(--color-black)]">
                {tier.name}
              </h3>
              <div className="mt-4 flex items-baseline gap-1.5">
                <span className="font-heading text-[42px] leading-none text-[color:var(--color-black)]">
                  ${tier.price}
                </span>
              ...
              <ul className="mt-7 flex-1 space-y-2.5">
                {tier.features.map((f) => (
                  <li
                    key={f}
                    className="flex items-start gap-2.5 text-[13.5px] text-[color:var(--color-gray-dark)]"
                  >
                    <svg
                      width="15"
                      height="15"
...
function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-[color:var(--color-crimson)] py-24 text-white">
      <div
        aria-hidden
      ...
      <div className="container-page relative text-center">
        <h2
          ...
          style={{ fontSize: "clamp(1.9rem, 4vw, 2.9rem)", lineHeight: 1.1 }}
        >
          Every artist is an entrepreneur.
        </h2>
        <p className="mx-auto mt-5 max-w-lg text-[16px] leading-relaxed text-white/80">
...
function SiteFooter() {
  return (
    <footer className="bg-[#0b0b0b] py-16 text-white">
      <div className="container-page">
